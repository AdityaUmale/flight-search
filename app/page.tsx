    ...
    <div className="container mx-auto p-8 w-12000px h-900px ml-120px ">
      ...
      <div className="bg-white rounded-lg shadow p-6 w-[1057px] h-[252px] flex flex-col ml-[72px]">
        ...
        <div className="flex justify-end mt-auto">
          <Button className="w-[249px] h-[48px] rounded-tl-[7px] bg-[#003E39] flex items-center justify-center">
            <Search size={16} className="mr-2" />
            <span className="font-neue-montreal text-base font-medium leading-4 tracking-[0.05em] text-left">Search flights</span>
          </Button>
        </div>
      </div>
    </div>
